...
if [ "$TRAVIS_REPO_SLUG" == "locomotivemtl/charcoal-project-boilerplate" ] && [ "$TRAVIS_PULL_REQUEST" == "false" ] && [ "$TRAVIS_PHP_VERSION" == "5.6" ]; then
    ...
    echo -e ">>> http://locomotivemtl.github.io/charcoal-project-boilerplate/apigen/$TRAVIS_BRANCH/ \n"
fi
